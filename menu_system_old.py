...
def menu(name):
  ...
  while menu_choice in range(7):
    ...
    if menu_choice == DISTANCE_CHOICE:
      # ---Question 1---
      while i < 10 and error_count < 5:
        try:
          # Requesting miles to convert
          miles = input(
            f"Good Sir {name}, how many miles would you like to convert to kilometers? "
          )
          if int(miles) > 0:
      ...
      while i < 10:
        try:
          ...
          gallons = input(
            f"How many gallons, good Sir {name}, do you require converting to litres? "
          )
          if int(gallons) > 0:
            # Call conversion function
      ...
      while i < 10:
        try:
          ...
          pounds = input(
            f"Now, Sir {name}, how many pounds shall we convert into kilograms? "
          )
          if int(pounds) > 0:
            # Call conversion function
      ...
      try:
        ...
        inches = input(
          f"Good Sir {name}, how many inches would you like to convert? ")
        if int(inches) > 0:
          # Call conversion function
      ...
      try:
        ...
        Fh = input(
          f"What temperature does {name} want converted to Centigrade? ")
        if int(Fh) < 1000:
          # Call conversion function
